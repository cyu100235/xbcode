...
) ENGINE = InnoDB AUTO_INCREMENT = 284 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统-部门菜单' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `xb_admin_rule` VALUES (2, '2024-03-27 15:57:58', '2024-07-22 16:50:10', '权限', 'auth', '', 0, 'none/index', '20', '10', '10', 'GET', 'Connection', '', 8888);
...
INSERT INTO `xb_admin_rule` VALUES (9, '2024-03-27 16:03:11', '2024-07-30 11:03:15', '退出登录', 'admin/Login/exit', '\\app\\admin\\controller\\LoginController@exit', 5, 'none/index', '10', '20', '20', 'DELETE', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (10, '2024-03-27 16:03:38', '2024-07-30 11:02:55', '清除缓存', 'admin/Index/clear', '\\app\\admin\\controller\\IndexController@clear', 5, 'remote/index', '10', '20', '20', 'DELETE', '', 'vue/admin/clear', 0);
INSERT INTO `xb_admin_rule` VALUES (11, '2024-03-27 16:04:09', '2024-07-30 11:03:25', '锁定屏幕', 'admin/Index/lock', '\\app\\admin\\controller\\IndexController@lock', 5, 'none/index', '10', '20', '20', 'DELETE', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (12, '2024-03-27 16:04:25', '2024-07-30 11:03:32', '解除锁定', 'admin/Index/unlock', '\\app\\admin\\controller\\IndexController@unlock', 5, 'none/index', '10', '20', '20', 'DELETE', '', '', 0);
...
INSERT INTO `xb_admin_rule` VALUES (21, '2024-03-27 16:19:10', '2024-03-27 16:19:10', '部门管理', 'admin/AdminRole/index', '\\app\\admin\\controller\\AdminRoleController@index', 2, 'table/index', '20', '10', '10', 'GET', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (22, '2024-03-27 16:19:10', '2024-03-27 16:19:10', '部门管理-表格', 'admin/AdminRole/indexTable', '\\app\\admin\\controller\\AdminRoleController@indexTable', 21, 'none/index', '10', '10', '10', 'GET', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (23, '2024-03-27 16:19:10', '2024-05-05 16:37:29', '部门管理-添加', 'admin/AdminRole/add', '\\app\\admin\\controller\\AdminRoleController@add', 21, 'form/index', '10', '10', '10', 'GET,POST', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (24, '2024-03-27 16:19:10', '2024-05-05 16:37:35', '部门管理-修改', 'admin/AdminRole/edit', '\\app\\admin\\controller\\AdminRoleController@edit', 21, 'form/index', '10', '10', '10', 'GET,PUT', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (25, '2024-03-27 16:19:10', '2024-05-05 16:37:43', '部门管理-删除', 'admin/AdminRole/del', '\\app\\admin\\controller\\AdminRoleController@del', 21, 'none/index', '10', '10', '10', 'GET,DELETE', '', '', 0);
...
INSERT INTO `xb_admin_rule` VALUES (31, '2024-03-27 16:20:43', '2024-05-05 16:37:52', '部门管理-授权', 'admin/AdminRole/auth', '\\app\\admin\\controller\\AdminRoleController@auth', 21, 'form/index', '10', '10', '10', 'GET,PUT', '', '', 0);
...
INSERT INTO `xb_admin_rule` VALUES (35, '2024-03-27 16:44:02', '2024-07-22 16:50:18', '插件', 'plugin', '', 0, 'none/index', '20', '10', '10', 'GET', 'ElemeFilled', '', 7777);
...
INSERT INTO `xb_admin_rule` VALUES (48, '2024-03-27 16:47:45', '2024-05-05 16:36:24', '插件管理-演示', 'admin/PluginsAction/demo', '\\app\\admin\\controller\\PluginsActionController@demo', 46, 'none/index', '10', '10', '10', 'GET', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (49, '2024-03-27 16:47:45', '2024-05-14 22:57:24', '插件管理-安装', 'admin/PluginsAction/install', '\\app\\admin\\controller\\PluginsActionController@install', 46, 'none/index', '10', '10', '10', 'GET,POST', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (50, '2024-03-27 16:47:45', '2024-05-05 16:36:36', '插件管理-卸载', 'admin/PluginsAction/uninstall', '\\app\\admin\\controller\\PluginsActionController@uninstall', 46, 'none/index', '10', '10', '10', 'DELETE', '', '', 0);
...
INSERT INTO `xb_admin_rule` VALUES (166, '2024-05-12 02:26:18', '2024-05-12 02:26:29', '插件管理-更新', 'admin/PluginsAction/update', '\\app\\admin\\controller\\PluginsActionController@update', 46, 'none/index', '10', '10', '10', 'GET,PUT', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (167, '2024-05-12 06:35:53', '2024-05-14 22:57:11', '插件管理-购买', 'admin/PluginsAction/order', '\\app\\admin\\controller\\PluginsActionController@order', 46, 'none/index', '10', '10', '10', 'GET,POST', '', '/vue/admin/plugins/order', 0);
INSERT INTO `xb_admin_rule` VALUES (168, '2024-05-12 15:49:35', '2024-05-15 11:29:46', '插件管理-统订单', 'admin/PluginsAction/unifiedOrder', '\\app\\admin\\controller\\PluginsActionController@unifiedOrder', 46, 'none/index', '10', '10', '10', 'GET', '', '/vue/admin/plugins/detail', 0);
...
INSERT INTO `xb_admin_rule` VALUES (234, '2024-05-17 10:46:50', '2024-05-17 10:46:50', '插件管理-详情', 'admin/PluginsAction/detail', '\\app\\admin\\controller\\PluginsActionController@detail', 46, 'remote/index', '10', '10', '10', 'GET', '', 'vue/admin/plugins/detail', 0);
INSERT INTO `xb_admin_rule` VALUES (266, '2024-05-20 14:45:13', '2024-05-20 14:45:13', '插件管理-配置', 'admin/PluginsAction/config', '\\app\\admin\\controller\\PluginsActionController@config', 46, 'form/index', '10', '10', '10', 'GET,PUT', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (267, '2024-05-29 11:29:19', '2024-05-29 11:29:39', '通用', 'currency', '', 0, 'none/index', '20', '10', '10', 'GET', 'Coin', '', 6666);
...
INSERT INTO `xb_admin_rule` VALUES (274, '2024-07-08 15:02:57', '2024-07-08 15:04:06', '插件管理-导入', 'admin/PluginsAction/import', '\\app\\admin\\controller\\PluginsActionController@import', 46, 'none/index', '10', '10', '10', 'POST', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (275, '2024-07-08 15:03:48', '2024-07-08 15:04:18', '插件管理-导出', 'admin/PluginsAction/export', '\\app\\admin\\controller\\PluginsActionController@export', 46, 'none/index', '10', '10', '10', 'DELETE', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (276, '2024-07-13 16:04:53', '2024-07-13 16:04:58', '用户', 'user', '', 0, 'none/index', '20', '10', '10', 'GET', 'UserFilled', '', 3);
INSERT INTO `xb_admin_rule` VALUES (277, '2024-07-13 16:05:48', '2024-07-13 16:05:48', '用户管理', 'admin/User/index', '\\app\\admin\\controller\\UserController@index', 276, 'table/index', '20', '10', '10', 'GET', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (278, '2024-07-13 16:05:48', '2024-07-13 16:05:48', '用户管理-表格', 'admin/User/indexTable', '\\app\\admin\\controller\\UserController@indexTable', 277, 'none/index', '10', '10', '10', 'GET', '', NULL, 0);
INSERT INTO `xb_admin_rule` VALUES (279, '2024-07-13 16:05:48', '2024-07-13 16:05:48', '用户管理-添加', 'admin/User/add', '\\app\\admin\\controller\\UserController@add', 277, 'form/index', '10', '10', '10', 'GET,POST', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (280, '2024-07-13 16:05:48', '2024-07-13 16:05:48', '用户管理-修改', 'admin/User/edit', '\\app\\admin\\controller\\UserController@edit', 277, 'form/index', '10', '10', '10', 'GET,PUT', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (281, '2024-07-13 16:05:48', '2024-07-13 16:05:48', '用户管理-删除', 'admin/User/del', '\\app\\admin\\controller\\UserController@del', 277, 'none/index', '10', '10', '10', 'DELETE', '', '', 0);
INSERT INTO `xb_admin_rule` VALUES (282, '2024-07-30 11:06:40', '2024-07-30 11:06:40', '版本更新', 'admin/Updated/index', '\\app\\admin\\controller\\UpdatedController@index', 5, 'remote/index', '10', '10', '10', 'GET', '', 'vue/admin/updated', 0);
INSERT INTO `xb_admin_rule` VALUES (283, '2024-07-30 11:31:11', '2024-07-30 11:31:11', '重启系统', 'admin/Index/restart', '\\app\\admin\\controller\\IndexController@restart', 5, 'none/index', '10', '10', '10', 'POST', '', '', 0);