DROP TABLE IF EXISTS `xb_web_admin`;
CREATE TABLE `xb_web_admin`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '站点管理员' ROW_FORMAT = DYNAMIC;