...
class AdminRuleController extends XbController
{
    ...
    public function indexTable(Request $request)
    {
        ...
        $builder->addColumn('type', '菜单类型', [
            ...
            'params' => [
                'type' => 'dict',
                'props' => [
                    'options' => DictApi::get('menuTypeText')->dict(),
                    'style' => DictApi::get('menuTypeStyle')->style(),
                ],
            ],
        ]);
        ...
        $builder->addColumn('component', '组件类型', [
            ...
            'params' => [
                'type' => 'dict',
                'props' => [
                    'options' => DictApi::get('componentText')->dict(),
                    'style' => DictApi::get('componentStyle')->style(),
                ],
            ],
        ]);
    ...
    private function formView()
    {
        ...
        $builder->addControl('component', 'select', '菜单组件', 'none/index', $rule, [
            'options' => DictApi::get('componentText')->options(),
            'prompt' => '选择顶级菜单时，默认即可',
        ]);
        ...
        $builder->addRow('method', 'checkbox', '请求类型', ['GET'], [
            'options' => DictApi::get('methodsText')->options(),
        ]);
        ...
        $builder->addRow('is_show', 'radio', '显示隐藏', '10', [
            'col' => 12,
            'options' => DictApi::get('showText')->options(),
        ]);
        return $builder;
    }
