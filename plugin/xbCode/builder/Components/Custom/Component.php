...
class Component extends BaseSchema
{
     ...
     * @author 楚羽幽 958416459@qq.com
     */
    public function url(string $url, array $vars = [], array $option = [], string $type = 'xb-remote')
    {
        $this->type = $type;
     ...
     * @author 楚羽幽 958416459@qq.com
     */
    public function body(string $component, array $vars = [], array $option = [], string $type = 'xb-render')
    {
        $this->type = $type;
