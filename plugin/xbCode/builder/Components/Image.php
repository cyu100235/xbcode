 ...
 * @method $this enlargeAble(bool $value) 设置支持放大预览
 * @method $this enlargeTitle(string $value) 设置放大预览的标题
 * @method $this enlargeCaption(string $value) 设置放大预览的描述
 * @method $this enlargeWithGallary(string $value) 表格中图片放大功能会默认展示所有图片信息，false将关闭放大图片集列表展示
...
class Image extends BaseSchema
{
    ...
    public string $thumbMode = 'cover';
    public string $thumbRatio = '4:6';
}
