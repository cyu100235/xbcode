...
class XbCrud extends Base
{
     ...
     * @copyright 贵州积木云网络科技有限公司
     */
    protected string $crudName = 'crud';
    ...
    {
        // 表格ID
        $this->useCRUD()->id($this->crudName);
        // 表格名称
        $this->useCRUD()->name($this->crudName);
        // 设置当前页面完整地址
     ...
     * @copyright 贵州积木云网络科技有限公司
     */
    public function setCrudName(string $name)
    {
        $this->crudName = $name;
        return $this;
    }
