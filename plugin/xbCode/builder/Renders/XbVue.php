 ...
 * @author 楚羽幽 958416459@qq.com
 */
class XbVue implements JsonSerializable
{
    /**
     * 页面实例
     * @var Page
     ...
     * @author 楚羽幽 958416459@qq.com
     */
    public static function make(string $api, array $vars = [], array $option = []): XbVue
    {
     ...
     * @author 楚羽幽 958416459@qq.com
     */
    public static function view(string $content, array $vars = [], array $option = []): XbVue
    {
        $component = new static;
