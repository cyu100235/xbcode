...
class AppsEntry
{
    ...
    {
        // 获取版权配置
        $beian = ConfigApi::get('copyright');
        $about_name = $beian['about_name'] ?? '';
        $about_url = $beian['about_url'] ?? '';
        $system_name = $beian['system_name'] ?? config('project.title', '积木云');
        $system_url = $beian['system_url'] ?? config('project.url', 'http://www.xbcode.net');
        $system_version = config('project.version_name', '1.0.0');
    ...
    {
        // 是否开启验证码
        $isCaptcha = $config['public_api']['is_captcha'] ?? false;
        $captchaUrl = '';
    ...
    {
        return [
            'index' => $config['upload_cate_api']['index'] ?? xbUrl('xbUpload/admin/Category/index', [], false, false, false),
            'add' => $config['upload_cate_api']['add'] ?? xbUrl('xbUpload/admin/Category/add', [], false, false, false),
            'edit' => $config['upload_cate_api']['edit'] ?? xbUrl('xbUpload/admin/Category/edit', [], false, false, false),
            'del' => $config['upload_cate_api']['del'] ?? xbUrl('xbUpload/admin/Category/del', [], false, false, false),
        ];
    }
    ...
    {
        return [
            'index' => $config['uploadify_api']['index'] ?? xbUrl('xbUpload/admin/Upload/index', [], false, false, false),
            'upload' => $config['uploadify_api']['upload'] ?? xbUrl('xbUpload/admin/Upload/upload', [], false, false, false),
            'chunk' => $config['uploadify_api']['chunk'] ?? xbUrl('xbUpload/admin/Upload/chunk', [], false, false, false),
            'edit' => $config['uploadify_api']['edit'] ?? xbUrl('xbUpload/admin/Upload/edit', [], false, false, false),
            'move' => $config['uploadify_api']['move'] ?? xbUrl('xbUpload/admin/Upload/move', [], false, false, false),
            'del' => $config['uploadify_api']['del'] ?? xbUrl('xbUpload/admin/Upload/del', [], false, false, false),
        ];
    }
    ...
    {
        return [
            'image' => $config['editor_upload']['image'] ?? xbUrl('xbUpload/admin/Editor/image', [], false, false, false),
            'video' => $config['editor_upload']['upload'] ?? xbUrl('xbUpload/admin/Editor/video', [], false, false, false),
            'file' => $config['editor_upload']['upload'] ?? xbUrl('xbUpload/admin/Editor/file', [], false, false, false),
        ];
    }
