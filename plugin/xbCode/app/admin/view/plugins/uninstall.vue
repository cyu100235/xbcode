...
export default {
    ...
    mounted() {
        ...
        this.addStep(`正在卸载 【${this.plugin.title}】 插件...`, 'install')
        setTimeout(() => {
            // 取第一个数组
    ...
    methods: {
        install() {
            ...
            this.$xbcode.$http.post('app/xbCode/admin/Plugins/uninstall', {
                ...
                if (step.next === 'success') {
                    ...
                    this.$xbcode.useConfirm('插件卸载完成...', 'success', '微信提示', {
                    ...
                    this.addStep(res?.msg ?? '插件卸载失败', 'fail', 'error')
                }
            }).catch(err => {
