...
use plugin\xbDeveloper\api\PluginsUpdate;
...
{
    protected static $defaultName        = 'xb-plugin:update';
    protected static $defaultDescription = 'Xb Plugin update';
